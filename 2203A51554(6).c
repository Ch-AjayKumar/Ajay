...
-> In C programming, text files are read and written using text-based file input/output functions like fopen, 
   fscanf, fprintf, fgets, fputs, etc.
...
-> In C programming, binary files are read and written using binary file input/output functions like fread, 
   fwrite, fseek, ftell, etc.
